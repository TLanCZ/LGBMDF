...
from .sklearn_estimators import GCSGDClassifier,GCLR, GCExtraTreesClassifier, GCRandomForestClassifier, GCXGBClassifier ,GCGradientBoostingClassifier,GClightgbm,GCCatBoostClassifier,GCNGBClassifier
...
def get_estimator_class(est_type):
    ...
    if est_type == "LGBMClassifier":
        return GClightgbm
    if est_type == "CatBoostClassifier":
        return GCCatBoostClassifier
    if est_type == "NGBClassifier":
        return GCNGBClassifier
