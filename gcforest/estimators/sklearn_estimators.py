...
class GClightgbm(SKlearnBaseClassifier):
    def __init__(self,name,kwargs):
        ...
        if "random_state" in kwargs:
            kwargs["seed"] = kwargs["random_state"]
            kwargs.pop("random_state")
        super(GClightgbm,self).__init__(name,lgb.LGBMClassifier,kwargs)

class GCCatBoostClassifier(SKlearnBaseClassifier):
    def __init__(self,name,kwargs):
        import catboost as cb
        super(GCCatBoostClassifier,self).__init__(name,cb.CatBoostClassifier,kwargs)
        
class GCNGBClassifier(SKlearnBaseClassifier):
    def __init__(self,name,kwargs):
        import ngboost as nb
        super(GCNGBClassifier,self).__init__(name,nb.NGBClassifier,kwargs)
